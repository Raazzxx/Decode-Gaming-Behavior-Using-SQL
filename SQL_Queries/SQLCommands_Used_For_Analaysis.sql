...
create database Mentorness_project

 ALTER TABLE PLAYER_DETAILS
ALTER COLUMN L1_STATUS VARCHAR(30);

alter table PLAYER_DETAILS 
ALTER COLUMN L2_STATUS VARCHAR(30);

ALTER TABLE player_details alter column p_id int NOT NULL
...
EXEC sp_RENAME 'Level_Details.Timestamp', 'start_datetime', 'COLUMN'

alter table Level_Details
ALTER COLUMN Dev_Id varchar(10) not null;

 alter table Level_Details
ALTER COLUMN Difficulty varchar(15);
...
JOIN Level_Details as l ON p.P_ID = l.P_ID;
